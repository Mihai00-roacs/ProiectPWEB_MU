...
namespace DataAccess
{
    public class UnitOfWork
    {
        ...
        private IRepository<OfferAvailableInterval> offerAvailableInterval;

        public IRepository<OfferAvailableInterval> OfferAvailableInterval =>
            offerAvailableInterval ?? new BaseRepository<OfferAvailableInterval>(Context);
